...
tagAnalyticsCNIL.CookieConsent = function() {
    ...
    var gaProperty = 'www.biker-now.fr'
    ...
    function getDomainName() {
        if (domaineName != '') {
            ...
            if (hostname.indexOf("www.biker-now.fr") === 0)
    ...
    function showBanner(){
        ...
        div.innerHTML =  '<div style="background-color:#fff;text-align:center;z-index: 1;padding:5px; padding-top:60px;font-size:12px;border-bottom:1px solid #eeeeee;" id="cookie-banner-message" align="center">Ce site utilise Google Analytics.\
